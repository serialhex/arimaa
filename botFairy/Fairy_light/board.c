...
{
//    fp=fopen("log.txt","a"); // Undefine this to write output to a log file.
}

void BOARD_Message(void)
{
    fprintf(stderr,"%s",message); // Undefine this to write output to stderr (i.e. the console window)
//    fprintf(fp,"%s",message); // Undefine this to write output to a log file.
}

void BOARD_Message_Exit(void)
{
//    fclose(fp); // Undefine this to write output to a log file.
}
